...
public class PluginManager implements ServiceConnection {
    ...
    public static final String BASE_PACKAGE = "com.ikould.musicpro";
    public static final String ACTION_PACKAGE_ADDED = BASE_PACKAGE + "PACKAGE_ADDED";
    public static final String ACTION_PACKAGE_REMOVED = BASE_PACKAGE + "PACKAGE_REMOVED";
    public static final String ACTION_DROIDPLUGIN_INIT = BASE_PACKAGE + "ACTION_DROIDPLUGIN_INIT";
    public static final String ACTION_MAINACTIVITY_ONCREATE = BASE_PACKAGE + "ACTION_MAINACTIVITY_ONCREATE";
    public static final String ACTION_MAINACTIVITY_ONDESTORY = BASE_PACKAGE + "ACTION_MAINACTIVITY_ONDESTORY";
    public static final String ACTION_SETTING = BASE_PACKAGE + "ACTION_SETTING";
    public static final String ACTION_SHORTCUT_PROXY = BASE_PACKAGE + "ACTION_SHORTCUT_PROXY";


    public static final String EXTRA_PID = BASE_PACKAGE + "EXTRA_PID";
    public static final String EXTRA_PACKAGENAME = BASE_PACKAGE + "EXTRA_EXTRA_PACKAGENAME";

    public static final String STUB_AUTHORITY_NAME = BASE_PACKAGE + "_sub";
    public static final String EXTRA_APP_PERSISTENT = BASE_PACKAGE + "EXTRA_APP_PERSISTENT";
